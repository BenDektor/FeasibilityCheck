...
\begin{figure}[!htbp]
    ...
    \caption{Testmaschine mit Board (große grüne Platte), Substraten (kleine senkrechten eingesteckte Plättchen auf Board) und Chips}
...
\begin{figure}[!htbp]
    ...
    \caption{Biegungs-Stresstest mit Karten}
