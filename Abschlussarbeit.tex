...
\begin{document}
	...
	\section*{}
	\vfill % Füllt den Raum vor dem Text
	\textbf{\Large Sperrvermerk} % Große, fette Überschrift linksbündig
	\vspace{1cm} % Abstand zwischen Überschrift und Text

	\noindent % Verhindert Einrückung am Anfang des Absatzes
	\parbox{0.9\textwidth}{ % 90% der Seitenbreite für bessere Lesbarkeit
	...
	\vfill % Füllt den Raum nach dem Text
	\cleardoublepage
